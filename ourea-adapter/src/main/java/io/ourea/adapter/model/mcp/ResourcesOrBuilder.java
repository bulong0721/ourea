...
public interface ResourcesOrBuilder extends
   ...
   */
  java.util.List<io.ourea.adapter.model.mcp.Resource> 
      getResourcesList();
  /**
   * <pre>
   * The response resources wrapped in the common MCP *Resource* message.
   ...
   * <code>repeated .istio.mcp.v1alpha1.Resource resources = 3;</code>
   */
  io.ourea.adapter.model.mcp.Resource getResources(int index);
  /**
   * <pre>
   * The response resources wrapped in the common MCP *Resource* message.
   * These are typed resources that match the type url in the
   ...
   * <code>repeated .istio.mcp.v1alpha1.Resource resources = 3;</code>
   */
  java.util.List<? extends io.ourea.adapter.model.mcp.ResourceOrBuilder> 
   ...
   * <code>repeated .istio.mcp.v1alpha1.Resource resources = 3;</code>
   */
  io.ourea.adapter.model.mcp.ResourceOrBuilder getResourcesOrBuilder(
      int index);
